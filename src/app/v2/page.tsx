  ...
  he: [
    {
      ...
      body: [
        <span key="1">אחר שנכנסתם למערכת <span className="text-[#e63946] font-bold">Health Guard</span> גיליתם שהווירוס <span className="text-[#e63946] font-bold">Shadow X</span> מחק חלק ממאגר הנתונים של מערכת הבריאות.</span>,
        ...
        <span key="3" className="text-[#e63946]">היזהרו! כל טעות תחזק את הווירוס.</span>
      ],
    ...
    },
    {
      ...
      body: [
        <span key="1">לאחר שחזרתם את הנתונים, מצאתם דלת סודית שהובילה למעבדת הבריאות המרכזית.</span>,
        <span key="2">שם גיליתם שהווירוס השתלט על מערכות קבלת ההחלטות של התלמידים וגרם להם לבחור בהרגלים מזיקים.</span>,
        <span key="3" className="text-[#00b4d8]">כדי לעצור את ההשפעה הזאת עליכם לפתור 10 שאלות נוספות המבוססות על ניתוח מידע, הסקת מסקנות וקבלת החלטות.</span>
      ],
    ...
    },
    {
      ...
      body: [
        <span key="1">כעת אתם נמצאים בלב המערכת.</span>,
        <span key="2"><span className="text-[#e63946] font-bold">Shadow X</span> הפעיל את מנגנון ההשמדה העצמית של <span className="text-[#e63946] font-bold">Health Guard</span>.</span>,
        <span key="3" className="text-[#00b4d8]">נשארו לכם 10 שאלות אחרונות המשלבות ידע מדעי, חשיבה ביקורתית וקבלת החלטות. רק אם תצליחו לפתור את כולן תוכלו לפתוח את הכספת המרכזית ולהציל את האנושות.</span>
      ],
  ...
  ar: [
    {
      ...
      body: [
        <span key="1">بعد دخولكم إلى نظام <span className="text-[#e63946] font-bold">Health Guard</span> اكتشفتم أن فيروس <span className="text-[#e63946] font-bold">Shadow X</span> قام بحذف جزء من قاعدة البيانات الصحية.</span>,
        ...
        <span key="3" className="text-[#e63946]">احذروا! فكل خطأ يقوي الفيروس.</span>
      ],
    ...
    },
    {
      ...
      body: [
        <span key="1">بعد استعادة البيانات وجدتم بابًا سريًا يقود إلى المختبر الصحي المركزي.</span>,
        <span key="2">هناك اكتشفتم أن الفيروس سيطر على أنظمة اتخاذ القرار لدى الطلاب وجعلهم يختارون عادات غير صحية.</span>,
        <span key="3" className="text-[#00b4d8]">لإيقاف تأثيره عليكم حل 10 أسئلة إضافية تعتمد على التحليل والاستنتاج واتخاذ القرار.</span>
      ],
    ...
    },
    {
      ...
      body: [
        <span key="1">أنتم الآن في قلب النظام.</span>,
        <span key="2"><span className="text-[#e63946] font-bold">Shadow X</span> قام بتفعيل آلية التدمير الذاتي لـ <span className="text-[#e63946] font-bold">Health Guard</span>.</span>,
        <span key="3" className="text-[#00b4d8]">تبقى أمامكم 10 أسئلة أخيرة تجمع بين المعرفة العلمية والتفكير النقدي واتخاذ القرار. فقط إذا نجحتم في حلها جميعًا ستتمكنون من فتح الخزنة المركزية وإنقاذ البشرية.</span>
      ],
